...
export default {
  ...
  cmu_creator: '由 Dimension 團隊傾力打造',
  ...
  inputEmail:'請輸入您的郵箱',
  inputCode:'請輸入驗證碼',
  passRule:'請輸入8-16位密碼，需包含字母（區分大小寫）和數字',
  checkPass:'請再次輸入密碼',
  changePass:'密碼修改成功',
  loginNow:'馬上登陸吧',
  checkPasswrong:'兩次輸入密碼不一致',
  pass:'請輸入密碼',
  sendCode:'發送校驗碼',
  inputCorrentEmail:'請輸入正確的郵箱地址',
  inputEmailCode:'請輸入郵箱驗證碼',
  reSend:'重新發送',
  welcome:'歡迎您回來',
  inputAccount:'請輸入6-12位主網賬號',
  next:'下一步',
  statement:'註冊用戶表明您接受本站',
  agreement:'用戶協議和隱私條例',
  dear:'尊敬的',
  finishRegister:'請進行最後的驗證來完成註冊！',
  finish:'完成',
  inputTel:'請輸入您的郵箱/手機號',
  accountRule:'格式要求：可以包括數字1-5，小寫字母和“.”。',
  unline:'暫未開放，敬請期待',
  wrongNumCode:'校驗碼錯誤',
  wrongImgCode:'驗證碼碼錯誤',
  resetS:'重置成功',
