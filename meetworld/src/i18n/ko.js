...
export default {
  ...
  cmu_creator: 'Dimension팀이 총력을 기울여 구축했다',
  powered_by: '에 의해 제공',
  ...
  country:'국가',
  codeLogin:'인증번호 등록', 
  passLogin:'ID 비밀번호 등록',
  registerAccount:'회원가입',
  forgetPass:'비밀번호 분실',	
  resetPass:'비밀번호 재설정',
  findPass:'비밀번호 찾기',
  inputEmail:'이메일 주소 입력',
  inputCode:'코드 입력',
  passRule:'8~16자리 비밀번호 입력 자음, 모음(대 소문자 구분), 숫자 포함 ',  
  checkPass:'비밀번호 재입력',
  changePass:'비밀번호 변경 완료 ',
  loginNow:'로그인 ',
  checkPasswrong:'비밀번호 확인해 주세요',
  pass:'비밀번호 입력 해주세요',
  sendCode:'인증 번호 발송',
  inputCorrentEmail:'정확한 이메일 주소 입력 부탁드립니다 ',
  inputEmailCode:'이메일 인증 번호 입력 부탁드립니다' ,
reSend:'재전송',
  welcome:'환영합니다',
  inputAccount:'6~12자리 아이디 입력',
  next:'다음',
 statement:'회원가입 진행은 본 사이트의\'개인정보 수집 및 이용동의\'에 동의 하는것이다',
  agreement:'개인정보 수집 및 이용동의',
  dear:'존경한',
  finishRegister:'마지막단계를 완성하세요 ',
  finish:'끝났습니다',
 inputTel:'메일/전화번호 입력하세요',
 accountRule:'양식 기준 : 1~5 숫자 포함 가능, 소문사 사용 가능, 특수문자 사용 가능',
 unline:'아직 열지 말고 계속 지켜봐주십시오.',
 wrongNumCode : '체크 코드 오류',
    wrongImgCode : '인증 코드 오류',
    resetS : '성공 재설정',
    resetF : '재설정 실패',
    loginS : '로그인 성공',
    loginF : '로그인 실패',
