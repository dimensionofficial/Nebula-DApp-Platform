...
export default {
  ...
  cmu_creator: '由 Dimension 团队倾力打造',
  ...
  inputEmail:'请输入您的邮箱',
  inputCode:'请输入验证码',
  passRule:'请输入8-16位密码，需包含字母（区分大小写）和数字',
  checkPass:'请再次输入密码',
  changePass:'密码修改成功',
  loginNow:'马上登陆吧',
  checkPasswrong:'两次输入密码不一致',
  pass:'请输入密码',
  sendCode:'发送校验码',
  inputCorrentEmail:'请输入正确的邮箱地址',
  inputEmailCode:'请输入邮箱验证码',
  reSend:'重新发送',
  welcome:'欢迎您回来',
  inputAccount:'请输入6-12位主网账号',
  next:'下一步',
  statement:'注册用户表明您接受本站',
  agreement:'用户协议和隐私条例',
  dear:'尊敬的',
  finishRegister:'请进行最后的验证来完成注册！',
  finish:'完成',
  inputTel:'请输入您的邮箱/手机号',
  accountRule:'格式要求：可以包括数字1-5，小写字母和“.”。',
  unline:'暂未开放，敬请期待',
  wrongNumCode:'校验码错误',
  wrongImgCode:'验证码码错误',
  resetS:'重置成功',
