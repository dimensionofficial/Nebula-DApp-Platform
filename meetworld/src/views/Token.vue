        ...
        <div class="country-content payoutComponent" v-show="tokenShow" v-if="dividendInfo && globalInfo">
          <b-tabs size="is-small" position="is-centered">
            <b-tab-item :label="$t('payout_pool_tab')" icon="chart-line">
              <div class="payoutpoolTab">
                ...
                <div style="padding: 0.5rem;">
                  ...
                  <h3 v-if="dividendInfo" class="title">{{$t('share_income')}}: <b style="color:  #fff">{{dividendInfo.ref_profit ? `${dividendInfo.ref_profit.div(10000).toDecimal(4)} EON` : '0.0000 EON'}}</b></h3>
                  <h3 v-if="dividendInfo" class="title">{{$t('create_portal_income')}}: <b style="color:  #fff">{{dividendInfo.fee_profit ? `${dividendInfo.fee_profit.div(10000).toDecimal(4)} EON` : '0.0000 EON'}}</b></h3> -->
                </div>
              </div>
            ...
            <b-tab-item v-if="scatterAccount" :label="$t('my_assets_tab')" icon="account">
              ...
              <h3 class="title">{{$t('my_CMU')}}: <b style="color:  #fff">{{balances.cmu || '0 EON'}}</b></h3>
            </b-tab-item>
            ...
            <b-tab-item :label="$t('bancor_trade_tab')" icon="chart-pie">
              ...
              <!-- <h3 class="title">{{$t('contract_supply')}}: <b style="color:  #fff"> </b></h3>
              <h3 class="title">{{$t('contract_balance')}}: <b style="color:  #fff"></b></h3>
              <h3 class="title">{{$t('contract_price')}}: <b style="color:  #fff"></b></h3>
              <div class="anniu">
...
export default {
  ...
  methods: {
    ...
    totalDividend (totalStaked, earningsPerShare) {
      ...
      return totalDividend.toDecimal(8) ? totalDividend.toDecimal(8) + ' EON' : '0.00000000 EON'
    },
